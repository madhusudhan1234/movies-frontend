...
import { Container, Image, Text, Button, Group, Badge, Stack, Title, Grid, Box, Divider, Anchor } from '@mantine/core';
import { useMediaQuery } from '@mantine/hooks';
import { FaArrowLeft, FaStar, FaCalendar, FaClock, FaGlobe, FaFilm, FaLanguage, FaFlag, FaTrophy, FaDollarSign, FaCompactDisc, FaBuilding, FaIdBadge, FaThumbsUp } from 'react-icons/fa';
